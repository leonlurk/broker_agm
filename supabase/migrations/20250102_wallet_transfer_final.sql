...
-- NOTA: Ya tienes estas tablas y columnas:
-- ✅ profiles.broker_balance (numeric) - Ya existe
-- ✅ broker_accounts - Ya existe
-- ✅ internal_transfers - Ya existe
-- ✅ users - Ya existe

-- Solo necesitamos crear/actualizar la función RPC

-- 1. FUNCIÓN RPC PARA MANEJAR TRANSFERENCIAS
...
-- 2. Función para obtener el balance del wallet principal
...
-- 3. Función para actualizar el balance del wallet (para depósitos/retiros)
...
-- Asegurar que los usuarios solo puedan ver/modificar sus propios datos
...
-- ========================================
-- Esta migración:
-- 1. ✅ Es compatible con tu estructura actual
-- 2. ✅ Usa las tablas correctas (profiles, broker_accounts, internal_transfers)
-- 3. ✅ Maneja transferencias desde wallet principal a MT5
-- 4. ✅ Mantiene compatibilidad con transferencias entre MT5
-- 5. ✅ Incluye funciones auxiliares útiles
-- 6. ✅ Agrega políticas de seguridad RLS