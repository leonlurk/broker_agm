...
import { Copy, Eye, EyeOff, Check, X, Settings } from 'lucide-react';
...
const TradingAccounts = ({ setSelectedOption, navigationParams }) => {
  ...
  // Función para generar datos del gráfico de beneficio total
  ...
  const benefitChartData = generateBenefitChartData();
            ...
            accountsForCurrentTab.map((account) => {
              ...
              >
                <div className="flex items-center">
                  ...
                  <div>
                      <h3 className="text-lg font-bold text-white mb-1">
                        {account.accountName || 'Cuenta sin nombre'} (ID: {account.accountNumber || 'N/A'})
                      </h3>
                ...
                <div className="flex items-center space-x-4">
                  {/* Status */}
                    <span className={`px-3 py-1 rounded-full text-sm ${accountStatus.statusColor}`}>
        ...
        <div className="lg:col-span-5 bg-gradient-to-br from-[#2a2a2a] to-[#1e1e1e] rounded-3xl p-6 border-t border-l border-r border-cyan-500">
          ...
          <div className="space-y-3">
            {isLoading ? (
              ...
              <div className="text-center text-gray-400 py-4">
                <p className="text-sm">No hay cuentas en esta categoría</p>
              </div>
            ) : (
              accountsForCurrentTab.map((account) => (
              <button 
                ...
                <div className="p-4 bg-[#1a1a1a] rounded-xl">
                  <div className="flex justify-between items-center mb-4">
                    <h3 className="font-medium text-white">Credenciales MT5</h3>
                          <span className={`px-3 py-1 rounded-full text-xs font-medium ${getAccountStatus(selectedAccount).statusColor}`}>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="p-3 bg-[#0f0f0f] rounded-lg relative group">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-white font-medium">{selectedAccount.server || 'AGM-Server'}</div>
                        <button
        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center mb-6">
              ...
              <div className="flex gap-2">
                <button 
                  ...
                  className={`px-4 py-2 bg-transparent rounded-full text-sm font-medium transition ${
              ...
              <div className="relative">
                <select 
                  ...
                  className="bg-[#3a3a3a] border border-[#444] rounded-lg px-4 py-2 text-white text-sm appearance-none pr-8"
                >
          ...
          <div className="space-y-6">
            ...
            <div className="p-6 bg-gradient-to-br from-[#2a2a2a] to-[#2d2d2d] border border-[#333] rounded-xl">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-2">
                    <button 
                      ...
                      className={`px-4 py-1 bg-transparent border rounded-full text-sm font-medium transition ${
              ...
              <div className="w-full h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={dynamicRendimientoData} margin={{ top: 20, right: 0, left: 0, bottom: 5 }}>
                    <CartesianGrid 
                      strokeDasharray="none" 
                      stroke="#333" 
                      horizontal={true} 
                    ...
                    <Tooltip
                      content={({ active, payload, label }) => {
                        if (active && payload && payload.length) {
                          ...
                          return (
                            <div className="bg-[#232323] border border-[#333] rounded-lg px-3 py-2 text-white text-sm">
                    ...
                    <Bar dataKey="value" barSize={35} radius={[4, 4, 0, 0]}>
                      ...
                      />
                      {dynamicRendimientoData.map((entry, index) => (
            ...
            <div className="p-6 bg-gradient-to-br from-[#2a2a2a] to-[#2d2d2d] border border-[#333] rounded-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
                {/* Instrumento */}
                <div>
                  <label className="block text-gray-400 text-sm mb-2">Instrumento</label>
                  <div className="relative">
                    <select 
