 ...
 * @param {string} params.master_account - La cuenta MT5 del master
 * @param {number} params.follower_account - La cuenta MT5 del seguidor
 * @param {number} [params.risk_ratio=1.0] - El ratio de riesgo para la copia
 * @returns {Promise<object>} La respuesta del servidor.
 */
export const followMaster = async ({ master_user_id, master_account, follower_account, risk_ratio = 1.0 }) => {
  try {
